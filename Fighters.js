import { HighKick, HighPunch, LowKick, LowPunch, SpinKick, SquatHighKick, SquatLowKick, SquatLowPunch, Uppercut } from "./Attacks.js"
import { BackwardJumpKick, BackwardJumpPunch, ForwardJumpKick, ForwardJumpPunch } from "./JumpAttacks.js"
import { BackwardJump, ForwardJump, Jump } from "./JumpMoves.js"
import { AttractiveStandUp, Block, Endure, Fall, KnockDown, Squat, SquatEndure, Stand, StandUp, Walk, WalkBackward, Win } from "./Moves.js"
...
const JUMP_ATTACK_MOVE_TYPES = [MOVE_TYPES.FORWARD_JUMP_KICK, MOVE_TYPES.FORWARD_JUMP_PUNCH, MOVE_TYPES.BACKWARD_JUMP_KICK, MOVE_TYPES.BACKWARD_JUMP_PUNCH]

const JUMP_MOVE_TYPES = [MOVE_TYPES.FORWARD_JUMP, MOVE_TYPES.JUMP, MOVE_TYPES.BACKWARD_JUMP]

const MOVING_MOVE_TYPES = [MOVE_TYPES.WALK, MOVE_TYPES.WALK_BACKWARD, MOVE_TYPES.FORWARD_JUMP, MOVE_TYPES.BACKWARD_JUMP, MOVE_TYPES.FORWARD_JUMP_KICK, MOVE_TYPES.FORWARD_JUMP_PUNCH, MOVE_TYPES.BACKWARD_JUMP_KICK, MOVE_TYPES.BACKWARD_JUMP_PUNCH]

export class Fighter {
    life = 100
    width = PLAYER_WIDTH
    haight = PLAYER_HEIGHT
